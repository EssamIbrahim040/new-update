...
<div class="container">
    <form action="sale.php" class="mt-4"  method="post">
         <h2 class="text-center">قسم المبيعات</h2> 
            ...
            <input class="form-control" id="validationServerUsername" aria-describedby="validationTooltipUsernamePrepend" required type="text" name="name" placeholder="ادخل اسم العميل"><br>
        </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"> التصميم</label>
                <input class="form-control" id="validationServerUsername" aria-describedby="validationTooltipUsernamePrepend" required type="text" name="type" placeholder="ادخل اسم التصميم"><br>
        </div>
        <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">تفاصيل التصميم</label>
                <input class="form-control" id="validationServerUsername" aria-describedby="validationTooltipUsernamePrepend" required type="text" placeholder="ادخل تفاصيل التصميم" name="detail"><br>
        </div>

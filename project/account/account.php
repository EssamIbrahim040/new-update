...
<div class="container"> 
    ...
    <a href="account.php" class="btn btn-primry">اضافة عميل جديد</a>
<style>
   ...
   <table>
     ...
     $result = mysqli_query($conn,$query);
         ...
         <tr>
            ...
            <td id="content"><?php echo $row['type']; ?></td>
            ...
            <td>
               ...
               <a href=""  onclick="show()" name="delete_account" class="delete-btn"> <i class="fas fa-trash"></i> Remove </a>

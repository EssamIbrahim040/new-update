...
<div class="container">
    <form action="code.php" class="mt-4"  method="post">
         <h2 class="text-center"> اضافة عميل جديد</h2> 
         ...
         <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text"  id="validationServerUsername" aria-describedby="validationTooltipUsernamePrepend" required name="type" placeholder="ادخل اسم التصميم"><br>
        </div>
        <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">تفاصيل التصميم</label>
                <input class="form-control" type="text"  id="validationServerUsername" aria-describedby="validationTooltipUsernamePrepend" required placeholder="ادخل تفاصيل التصميم" name="detail"><br>
        </div>
        <div class="mb-3">
